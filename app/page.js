  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="voguevault.com - Wear It!" />
      </Head>
      
      <div>
        <Image src="/home.png" alt="" width={1480} height={400}></Image>
      </div>
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-400">
              Wear the Vogue with Elegance
            </h1>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">
              Welcome to Vogue Vault, your destination for chic, timeless
              fashion. Unlock your style potential today!
            </p>
          </div>
